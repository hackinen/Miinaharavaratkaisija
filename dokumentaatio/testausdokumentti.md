...
Näiden kymmenen peliä sisältävien otosten perusteella 10x10-kentässä pelin voittamisen onistumisprosentti oli 100%, 16x16-kentässä 80% ja 16x30-kentässä 50%. Erityisesti viimeisessä kentässä onnistumisprosentti on todennäköisesti varsin epätarkka, sillä kymmenen peliä on vielä kohtuullisen pieni otanta ja tässä suurimmassa kentässä on eniten vaihtelua voiton ja häviämisen välillä.
